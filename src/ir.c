...
const char *t_opcode_names[] = {
    ...
    [T_OP_GREATER_EQUALS]    = "T_OP_GREATER_EQUALS",
    [T_OP_GREATER_THAN]      = "T_OP_GREATER_THAN",
    [T_OP_JUMP]              = "T_OP_JUMP",
    [T_OP_JUMP_COND]         = "T_OP_JUMP_COND",
    [T_OP_JUMP_NCOND]        = "T_OP_JUMP_NCOND",
    [T_OP_LESS_EQUALS]       = "T_OP_LESS_EQUALS",
    [T_OP_LESS_THAN]         = "T_OP_LESS_THAN",
    [T_OP_MULT]              = "T_OP_MULT",
    [T_OP_NOT]               = "T_OP_NOT",
    [T_OP_NOT_EQUALS]        = "T_OP_NOT_EQUALS",
    [T_OP_OR]                = "T_OP_OR",
    ...
    [T_OP_SUB]               = "T_OP_SUB",
    [T_OP_SWAP]              = "T_OP_SWAP",
    [T_OP_AS_WORD]           = "T_OP_AS_WORD",
    [T_OP_AS_BYTE]           = "T_OP_AS_BYTE",
    [T_OP_AS_PTR]            = "T_OP_AS_PTR",
    [T_OP_AS_INT]            = "T_OP_AS_INT",
    ...
    [T_OP_AS_F32]            = "T_OP_AS_F32",
    [T_OP_AS_F64]            = "T_OP_AS_F64",
    [T_OP_AS_CHAR]           = "T_OP_AS_CHAR",
    [T_OP_AS_CHAR16]         = "T_OP_AS_CHAR16",
    [T_OP_AS_CHAR32]         = "T_OP_AS_CHAR32",
    [T_OP_TO_WORD]           = "T_OP_TO_WORD",
    [T_OP_TO_BYTE]           = "T_OP_TO_BYTE",
    [T_OP_TO_PTR]            = "T_OP_TO_PTR",
    [T_OP_TO_INT]            = "T_OP_TO_INT",
    [T_OP_TO_U8]             = "T_OP_TO_U8",
    [T_OP_TO_U16]            = "T_OP_TO_U16",
    [T_OP_TO_U32]            = "T_OP_TO_U32",
    [T_OP_TO_S8]             = "T_OP_TO_S8",
    [T_OP_TO_S16]            = "T_OP_TO_S16",
    [T_OP_TO_S32]            = "T_OP_TO_S32",
    [T_OP_TO_F32]            = "T_OP_TO_F32",
    [T_OP_TO_F64]            = "T_OP_TO_F64",
    [T_OP_TO_CHAR]           = "T_OP_TO_CHAR",
    [T_OP_TO_CHAR16]         = "T_OP_TO_CHAR16",
    [T_OP_TO_CHAR32]         = "T_OP_TO_CHAR32",
...
const char *w_opcode_names[]  = {
    ...
    [W_OP_POP]                = "W_OP_POP",
    [W_OP_POPN8]              = "W_OP_POPN8",
    [W_OP_POPN16]             = "W_OP_POPN16",
    [W_OP_POPN32]             = "W_OP_POPN32",
    [W_OP_ADD]                = "W_OP_ADD",
    [W_OP_ADDF32]             = "W_OP_ADDF32",
    [W_OP_ADDF64]             = "W_OP_ADDF64",
    [W_OP_AND]                = "W_OP_AND",
    [W_OP_DEREF]              = "W_OP_DEREF",
    [W_OP_DIVF32]             = "W_OP_DIVF32",
    [W_OP_DIVF64]             = "W_OP_DIVF64",
    ...
    [W_OP_GREATER_EQUALS]     = "W_OP_GREATER_EQUALS",
    [W_OP_GREATER_THAN]       = "W_OP_GREATER_THAN",
    [W_OP_HIGHER_SAME]        = "W_OP_HIGHER_SAME",
    [W_OP_HIGHER_THAN]        = "W_OP_HIGHER_THAN",
    [W_OP_JUMP]               = "W_OP_JUMP",
    [W_OP_JUMP_COND]          = "W_OP_JUMP_COND",
    [W_OP_JUMP_NCOND]         = "W_OP_JUMP_NCOND",
    [W_OP_LESS_EQUALS]        = "W_OP_LESS_EQUALS",
    [W_OP_LESS_THAN]          = "W_OP_LESS_THAN",
    [W_OP_LOWER_SAME]         = "W_OP_LOWER_SAME",
    [W_OP_LOWER_THAN]         = "W_OP_LOWER_THAN",
    [W_OP_MULT]               = "W_OP_MULT",
    [W_OP_MULTF32]            = "W_OP_MULTF32",
    [W_OP_MULTF64]            = "W_OP_MULTF64",
    [W_OP_NOT]                = "W_OP_NOT",
    [W_OP_NOT_EQUALS]         = "W_OP_NOT_EQUALS",
    [W_OP_OR]                 = "W_OP_OR",
    [W_OP_PRINT]              = "W_OP_PRINT",
    [W_OP_PRINT_CHAR]         = "W_OP_PRINT_CHAR",
    [W_OP_PRINT_INT]          = "W_OP_PRINT_INT",
    [W_OP_PRINT_FLOAT]        = "W_OP_PRINT_FLOAT",
    [W_OP_PRINT_STRING]       = "W_OP_PRINT_STRING",
    [W_OP_SUB]                = "W_OP_SUB",
    [W_OP_SUBF32]             = "W_OP_SUBF32",
    [W_OP_SUBF64]             = "W_OP_SUBF64",
    [W_OP_SWAP]               = "W_OP_SWAP",
    ...
    [W_OP_FPROM]              = "W_OP_FPROM",
    [W_OP_FPROML]             = "W_OP_FPROML",
    [W_OP_FDEM]               = "W_OP_FDEM",
    [W_OP_ICONVF32]           = "W_OP_ICONVF32",
    [W_OP_ICONVF32L]          = "W_OP_ICONVF32L",
    [W_OP_ICONVF64]           = "W_OP_ICONVF64",
    [W_OP_ICONVF64L]          = "W_OP_ICONVF64L",
    [W_OP_FCONVI32]           = "W_OP_FCONV32",
    [W_OP_FCONVI64]           = "W_OP_FCONV64",
    [W_OP_ICONVC32]           = "W_OP_ICONVC32",
    [W_OP_CHAR_8CONV32]       = "W_OP_CHAR_8CONV32",
    [W_OP_CHAR_32CONV8]       = "W_OP_CHAR_32CONV8",
    [W_OP_CHAR_16CONV32]      = "W_OP_CHAR_16CONV32",
    [W_OP_CHAR_32CONV16]      = "W_OP_CHAR_32CONV16",
